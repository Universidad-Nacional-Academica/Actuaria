...
Calculando la probabilidad de que una vida de (30) sobreviva la vida de (50) por lo menos en 20 años es:
...
Suponiendo que $(x_1^s)$ sufre de insuficiencia cardíaca. Sean dos vidas de la misma edad (30), la primera en condición sana y la segunda con IC la probabilidad de que ambas fallezcan antes de cumplir 50 años es:
