...
Encuentre $\mathbb{E}(T(x_1^s))= \textup{\r{e}}_{x_1^s}$. Encuentre
$1-\cfrac{\textup{\r{e}}_{x_1^s}}{e_{x_1}}$, el porcentaje se reduce la esperanza de vida de
...
Sea la probabilidad de fallecer dos vidas $x_1$ y $x_2$ antes de $t$ años como: 
...
y la fuerza de mortalidad sub-estándar.

```{=tex}
\begin{align*}
    \mu^{s}_{x+t} = \theta\mu_{x+t} \text{ con } \theta > 1
\end{align*}
```
...
\text{Por el modelo multiplicativo}  \\
                                          &= 1 - \prescript{}{t}{p}_{x_1} - \prescript{}{t}{p}_{x_1^\theta} + \prescript{}{t}{p}_{x_1}\prescript{}{t}{p}_{x_1^\theta} \\
...
```{=tex}
\begin{align*}
\prescript{}{20}{q}_{\overline{30, 30^s}} &= \left(1- \prescript{}{20}{p}_{30}\right) (1 - \prescript{}{20}{p}_{30^{1.2}})\\
\end{align*}
```
...
\mathbb{P}(T(x_1) < T(x_1^s)) &= \int_0^{\omega-x} P(T(x_1) < T(x_1^s) \arrowvert T(x_1) = t) \prescript{}{t}{p}_{x_1}\mu_{x_1 + t}dt\\
                              ...
                              &= \int_0^{\omega-x}e^{-\theta t}(\prescript{}{t}{p}_{x_1})^2\mu_{x_1+t} dt
\end{align*}
```
